...
#
	...
	cat apertium-azz.azz.lexc | grep -v 'Dir/LR' | hfst-lexc --Werror -o azz.RL.lexc.hfst
	...
	hfst-compose-intersect -1 azz.RL.lexc.hfst -2 azz.twol.hfst | hfst-compose-intersect -1 - -2 azz.mor.twol.hfst  -o azz.gen.RL.hfst
#
...
#
	hfst-fst2fst -O azz.gen.RL.hfst -o azz.autogen.hfst
#
